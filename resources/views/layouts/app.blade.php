                ...
                <ul class="header_menu">
                    ...
                    <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                        <div class="user_item dropdown-menu dropdown-menu-right">
                            <div class="admin">
                                <a href="#" class="user_link"><img src="{{asset('panel/assets/images/admins.jpg')}}" alt=""></a>
                            </div>
                            <ul>
                                ...
                                <li><a href="{{route('logout.users')}}"><span><i class="fas fa-unlock-alt"></i></span> Logout</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
