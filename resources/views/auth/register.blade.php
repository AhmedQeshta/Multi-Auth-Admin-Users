                ...
                <div class="center_content">
                    ...
                    <form action="{{ route('register') }}" method="post">
                        ...
                        <div class="form-group icon_parent">
                            ...
                            <input id="name" type="text"  class="form-control @error('name') is-invalid @enderror" name="name" value="" required autocomplete="name" autofocus placeholder="Full Name">
                        ...
                        <div class="form-group icon_parent">
                            ...
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="" required autocomplete="email" placeholder="Email Address">
